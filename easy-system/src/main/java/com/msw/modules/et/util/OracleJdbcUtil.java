...
public class OracleJdbcUtil {
    ...
    public Connection getConnection(String url, String username, String password, int port) throws SQLException {
//        url = "jdbc:oracle:thin:@" + url + ":" + port + "/server_taf2";  //server_taf2
        url = "jdbc:oracle:thin:@" + url + ":" + port + ":SID";  //server_taf2
    ...
    private ResultSetMetaData prepareRsmd(String sql, List<Object> params)
            throws SQLException {
    ...
    private void prepareRs(String sql, List<Object> params)
            throws SQLException {
        preparePstmt(sql, params);
        getRs();
    }

    private void preparePstmt(String sql, List<Object> params)
            throws SQLException {
        getStmt(sql);
     ...
     * @throws SQLException
     */
    public List<HashMap<String, Object>> getListHashMap(String sql, List<Object> params) throws SQLException {
     ...
     * @throws SQLException
     */
    public <T> List<T> getListBean(String sql, Class<T> clazz, List<Object> params) throws InstantiationException, IllegalAccessException, SQLException {
     ...
     * @throws SQLException
     */
    public <T> List<T> getListCommBean(String sql, Class<T> clazz, List<Object> params) throws InstantiationException, IllegalAccessException, SQLException {
        List<T> list = new ArrayList<T>();
        T t = null;
        try {
            ResultSetMetaData rsmd = prepareRsmd(sql, params);
     ...
     */
    public <T> T getResultBean(Class<T> clazz, String sql, List<Object> params) throws SQLException, InstantiationException, IllegalAccessException, IntrospectionException, InvocationTargetException {
        T t = null;
        try {
     ...
     * @throws SQLException
     */
    private <T> void invokeBeanValue(T t, int i, String propertyType, String propertyName) throws IllegalAccessException, InvocationTargetException, IntrospectionException, SQLException {
     ...
     * @throws SQLException
     */
    private <T> void setBeanValue(T t, int i, Field field, String fieldTypeString) throws IllegalAccessException, SQLException {
        boolean bFlag = field.isAccessible();
        field.setAccessible(true);//打开javabean的访问权限
     ...
     * @throws SQLException
     */
    public int updateRecord(String sql, List<Object> params) throws SQLException {
        int iNum = 0;
        try {
            preparePstmt(sql, params);
