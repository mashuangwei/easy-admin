...
public class MysqlJdbcUtil {
    ...
    private String suffix = "?serverTimezone=Asia/Shanghai&characterEncoding=utf8&useSSL=false";
    ...
    // 定义获得数据库的连接
    public Connection getConnection(String url, String username, String password, int port, String database_name) {
        url = prefix + ":" + port + "/" + database_name + suffix;
        try {
    ...
    public boolean updateByPreparedStatement(String sql, List<Object> params) throws SQLException {
        ...
        if (params != null && !params.isEmpty()) {
            for (int i = 0; i < params.size(); i++) {
                preparedStatement.setObject(index++, params.get(i)); // 填充占位符
            }
        }
    ...
    public Map<String, Object> findSimpleResult(String sql, List<Object> params)
        ...
        ResultSetMetaData metaData = preparedStatement.getMetaData(); // 获取 结果中，一行所有列的结果
    ...
    public List<Map<String, Object>> findMoreResult(String sql,
        ...
        resultSet = preparedStatement.executeQuery(); // 返回查询结果集合
